...
\caption{不同入纤功率下16-QAM星座图概览：EDC输出（上行）与原始发射符号（下行）对比，展示了随功率增大而加剧的非线性失真。}
\label{fig:overview}
\end{figure}
...
\caption{MLP-NLC带来的$Q$因子增益随入纤功率变化}
\label{fig:qgain}
\end{figure}
